...
bool Setting::init()
{
	...
	auto SoundToggleMenuItem = MenuItemToggle::createWithCallback(
		...
		SoundOnMenuItem,
		NULL);
	SoundToggleMenuItem->setPosition(500,700);
	...
	auto backItem = MenuItemImage::create("ok.png", "ok.png");
	backItem->setPosition(500, 100);

     Menu *mm2 = Menu::create(SoundOnMenuItem, MusicOffMenuItem, backItem, NULL);
